            ...
            <form name="formulario" method="POST" action="validar.jsp">
                <fieldset style="width: 300px">
                    ...
                    <div>
                        ...
                        <p>Contraseña: <input type="password" name="pass" value="" size="20" required="required" style="float: right"/> </p>
                        <p>Repetir contraseña: <input type="password" name="pass2" value="" size="20" required="required" style="float: right"/> </p>
                        ...
                        <br>
                        <div id="botones">
                            <input type="submit" value="Aceptar" name="enviar" onblur="<% if (request.getParameter("pass") != request.getParameter("pass2")) {%>
