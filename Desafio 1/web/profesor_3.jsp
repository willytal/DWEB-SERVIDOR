...
<html>
    ...
    <body>
        ...
        <form name="formaulas" id="form_aulas" method="POST" action="controlador.jsp"> <!-- -->
            ...
            <fieldset>
                <legend> Inventario del aula %> </legend>
                ...
                <div>
                    ...
                    <label> ID Item: </label> <input type="text" name="cajaitem" hidden="" value="<% out.print(it.getId_item()); %>" size="2" />
                    <label> ID Aula: </label>  <input type="text" name="cajaaula" hidden="" value="<% out.print(it.getId_aula()); %>" size="2" />
                    <br>
                    <%
